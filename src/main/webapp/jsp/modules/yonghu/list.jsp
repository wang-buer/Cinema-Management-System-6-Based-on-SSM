...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shoujihaomaSearch" class="form-control form-control-sm" placeholder="请输入手机号码" aria-controls="tableId">
									<label>
										邮箱
									</label>
									<input type="text" id="youxiangSearch" class="form-control form-control-sm" placeholder="请输入邮箱" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			...
			if($('#shoujihaomaSearch').val() != null && $('#shoujihaomaSearch').val() != ''){
				searchForm.shoujihaoma ="%" +  $('#shoujihaomaSearch').val() + "%";
			}
			
			if($('#youxiangSearch').val() != null && $('#youxiangSearch').val() != ''){
				searchForm.youxiang ="%" +  $('#youxiangSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("yonghu/page","GET",{
				...
				shoujihaoma : searchForm.shoujihaoma,	
				youxiang : searchForm.youxiang,	
			},(res)=>{
				if(res.code == 0){
					clear();
